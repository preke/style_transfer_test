...
def get_pos_neg_rep(word_2_index, pretrained_weight):
    ...
    pos_lex_list = torch.FloatTensor([pretrained_weight[word_2_index[i]] for i in pos_lex_list])
    neg_lex_list = torch.FloatTensor([pretrained_weight[word_2_index[i]] for i in neg_lex_list])
